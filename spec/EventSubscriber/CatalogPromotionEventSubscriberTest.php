...
{
    /** @var CatalogPromotionAnnouncerInterface|MockObject */
    private MockObject $catalogPromotionAnnouncerMock;
    ...
    public function testUsesAnnouncerToDispatchCatalogPromotionCreatedEventAfterWritingCatalogPromotion(): void
    {
        ...
        $this->catalogPromotionAnnouncerMock->expects($this->once())->method('dispatchCatalogPromotionCreatedEvent')->with($catalogPromotionMock);
    ...
    public function testUsesAnnouncerToDispatchCatalogPromotionUpdatedEventAfterChangingCatalogPromotion(): void
    {
        ...
        /** @var Request|MockObject $requestMock */
        $requestMock = $this->createMock(Request::class);
        $requestMock->expects($this->once())->method('getMethod')->willReturn(Request::METHOD_PUT);
        $this->catalogPromotionAnnouncerMock->expects($this->once())->method('dispatchCatalogPromotionUpdatedEvent')->with($catalogPromotionMock);
        $this->catalogPromotionEventSubscriber->postWrite(new ViewEvent(
            $kernelMock,
            $requestMock,
            HttpKernelInterface::MAIN_REQUEST,
    ...
    public function testDoesNothingAfterWritingOtherEntity(): void
    {
        ...
        /** @var Request|MockObject $requestMock */
        $requestMock = $this->createMock(Request::class);
        $this->catalogPromotionAnnouncerMock->expects($this->never())->method('dispatchCatalogPromotionCreatedEvent');
        $this->catalogPromotionEventSubscriber->postWrite(new ViewEvent(
            $kernelMock,
            $requestMock,
            HttpKernelInterface::MAIN_REQUEST,
    ...
    public function testDoesNothingIfThereIsAWrongRequestMethod(): void
    {
        ...
        $this->catalogPromotionAnnouncerMock->expects($this->never())->method('dispatchCatalogPromotionCreatedEvent')->with($catalogPromotionMock);
        $this->catalogPromotionEventSubscriber->postWrite(new ViewEvent(
            $kernelMock,
            $requestMock,
            HttpKernelInterface::MAIN_REQUEST,
