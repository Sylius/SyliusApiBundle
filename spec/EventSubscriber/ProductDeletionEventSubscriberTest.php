...
{
    /** @var ProductInPromotionRuleCheckerInterface|MockObject */
    private MockObject $productInPromotionRuleCheckerMock;

    private ProductDeletionEventSubscriber $productDeletionEventSubscriber;

    protected function setUp(): void
    {
        $this->productInPromotionRuleCheckerMock = $this->createMock(ProductInPromotionRuleCheckerInterface::class);
        $this->productDeletionEventSubscriber = new ProductDeletionEventSubscriber($this->productInPromotionRuleCheckerMock);
    }
    ...
    public function testDoesNotThrowExceptionWhenProductIsNotBeingDeleted(): void
    {
        ...
        $this->productInPromotionRuleCheckerMock->expects($this->never())->method('isInUse')->with($productMock);
    ...
    public function testThrowsAnExceptionWhenTryingToDeleteProductThatIsInUseByAPromotionRule(): void
    {
        ...
        $this->productInPromotionRuleCheckerMock->expects($this->once())->method('isInUse')->with($productMock)->willReturn(true);
