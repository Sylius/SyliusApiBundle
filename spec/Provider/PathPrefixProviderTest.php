...
final class PathPrefixProviderTest extends TestCase
{
    ...
    {
        $this->assertSame('shop', $this->pathPrefixProvider->getPathPrefix('/api/v2/shop/certain-route'));
    }

    public function testReturnsAdminPrefixBasedOnTheGivenPath(): void
    {
        $this->assertSame('admin', $this->pathPrefixProvider->getPathPrefix('/api/v2/admin/certain-route'));
    }
    ...
    public function testReturnsPrefixFromApiRouteWithSlashes(): void
    {
        ...
        $this->assertSame('admin', $this->pathPrefixProvider->getPathPrefix('/api/long/route/name/admin/certain-route'));
    }
}
